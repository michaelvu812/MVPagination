...
// MVPagination
#define COCOAPODS_POD_AVAILABLE_MVPagination
#define COCOAPODS_VERSION_MAJOR_MVPagination 1
#define COCOAPODS_VERSION_MINOR_MVPagination 0
#define COCOAPODS_VERSION_PATCH_MVPagination 0
